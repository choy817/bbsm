                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user deleteUser" name="user deleteUser" id="deleteUser" method="post">
                                ...
                                <input type="button" onclick="javascript:sendIt();" class="btn btn-primary btn-user btn-block" value="회원탈퇴 ">
                            </form>
                            <hr>
                            <div class="text-center">
